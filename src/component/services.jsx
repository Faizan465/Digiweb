		...
		<div className="col-lg-3 col-md-3 col-sm-12 col-xs-12 Services-tab  item">
			<div className="folded-corner service_tab_1">
				<div className="text">
					...
					<p>
               We create designs that are attractive and functional. After all, the website represents  on the internet . 
					</p>
				</div>
			</div>
	    </div>
		...
		<div className="col-lg-3 col-md-3 col-sm-12 col-xs-12 Services-tab item">
			<div className="folded-corner service_tab_1">
				<div className="text">
					...
					<p>
               We strive to create the best digital content out there for all platforms such as the web, mobile, tablets
					</p>
				</div>
			</div>
		</div>
		<div className="col-lg-3 col-md-3 col-sm-12 col-xs-12 Services-tab item">
			<div className="folded-corner service_tab_1">
				<div className="text">
					...
					<p>
               We believe to produce top notch quality work which please our clients and help them to meet their  goals.
					</p>
				</div>
			</div>
		</div>
		...
		<div className="col-lg-3 col-md-3 col-sm-12 col-xs-12 Services-tab item">
			<div className="folded-corner service_tab_1">
				<div className="text">
					...
					<p>
               We work with the world's top Development agencies to create flawless Design contents with super-slick  at digiweb.
					</p>
				</div>
			</div>
		</div>
		<div className="col-lg-3 col-md-3 col-sm-12 col-xs-12 Services-tab item">
				<div className="folded-corner service_tab_1">
					<div className="text">
						...
						<p>
                  If you can imagine it, we can build it. We use lightweight code libraries, tricks, hacks, secret  
						</p>
				</div>
			</div>
		</div>
		<div className="col-lg-3 col-md-3 col-sm-12 col-xs-12 Services-tab item">
			<div className="folded-corner service_tab_1">
				<div className="text">
					...
					<p>
					With an experience of more than 5+ years,Having experts on Website design, Development , E-Commerce  etc.
					</p>
				</div>
			</div>
		</div>
